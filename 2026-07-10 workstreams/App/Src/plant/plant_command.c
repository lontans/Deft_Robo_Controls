...
void plant_command_image_dispatch(const host_command_image_t *cmd)
{
	...
	/* 2026-07-10 workstreams: bench thermocouple probe (TMP tag). Read-only,
	 * no actuator interaction — does not need to gate desire mounting below,
	 * only needs to arm the next feedback frame's mirror. */
