...
|-------|----------------------|------|
| Laptop Controls PCB | `0` | USB FS CDC → `COM*` |
| Jetson | `1` | UART4 PC10/11 @ 115200 |

**Conflict:** Jetson host UART and PDB UART both want UART4 — boards with a populated PDB connector must use USB host + `UART4_MODE_PDB` (see [plant.md](plant.md)#pdb-kill).
