...
Mirrors App/Src/plant/plugins/cubemars.c MIT path. Pack layout matches Damiao
MIT — not the broken sample in the CubeMars PDF.

Legacy Servo Mode (ext-ID mode 6) lives in
scripts/pcb_lab/legacy/controls_pcb_host/protocol/cubemars.py and is intentionally
not expanded here.
"""
