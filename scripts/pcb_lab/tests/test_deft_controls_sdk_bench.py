"""Golden tests for deft_controls_sdk/debug (no hardware).
...
from deft_controls_sdk.debug.config import fetch_table
from deft_controls_sdk.debug.lease import lease
