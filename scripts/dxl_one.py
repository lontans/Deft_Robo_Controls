...
"""Single-DXL range check — move only one servo so you can see awkward limits.
  ...
  cd scripts
  python dxl_one.py --slot 0          # id 1, plant_config ranges
  python dxl_one.py --slot 1          # id 2
  python dxl_one.py --slot 0 --hold   # hold mid only (no sweep)
...
from deft_controls_sdk.bench.servo_fb import sample_servo_fb
